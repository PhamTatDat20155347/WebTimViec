		...
		<div class="col-md-8">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					@endif
					<form action="nhatuyendung/sua/{{$post->id}}" method="post" enctype="multipart/form-data">
						<input type="hidden" name="_token" value="{{csrf_token()}}">
						<div>
							<label style="font-style: italic; color: black;">Tiêu đề</label>
							<input type="text" class="form-control" placeholder="tiêu đề" name="title" aria-describedby="basic-addon1" value="{{$post->title}}">
						</div>
						<br>
						...
						<div>
							...
							<input type="text" value="{{$post->content}}" class="form-control" placeholder="Nội dung" name="content" aria-describedby="basic-addon1"
							>
						</div>
						<br>	
						<div>
							<label style="font-style: italic; color: black;">Từ khóa</label>
							<input type="text" value="{{$post->keywork}}" class="form-control" name="keywork" aria-describedby="basic-addon1">
						</div>
						<br>
						<div>
						...
						<br>
						<div>
							<img src="upload/post/{{$post->Hinh}}" width='200px;' height:'100px';">
							<label style="font-style: italic; color: black;"></label>
							<input type="file" class="form-control" name="Hinh">
						</div>
						<br>
						<button style="background-color: #E7176F; border-radius: 20px; font-size: 30px;color: white; width: 100%;"  type="submit" class="btn btn-default">Sửa bài
						</button>
